            ...
            {(formikProps) => (
              <React.Fragment key="formikSearch">
                <View style={styles.form_view}>
                  ...
                  <Picker
                    style={styles.picker_style}
                    selectedValue={formikProps.values.espece}
                    onValueChange={formikProps.handleChange("espece")}
                    itemStyle={styles.picker_item}
                  >
                    <Picker.Item label="Non précisé" value="" />
                    <Picker.Item label="Chien" value="Chien" />
                ...
                <View style={styles.form_view}>
                  ...
                  <Picker
                    style={styles.picker_style}
                    selectedValue={formikProps.values.sexe}
                    onValueChange={formikProps.handleChange("sexe")}
                    itemStyle={styles.picker_item}
                  >
                    <Picker.Item label="Non précisé" value="" />
                    <Picker.Item label="Femelle" value="Femelle" />
                ...
                <View style={styles.textContainerPrice}>
                  ...
                  {console.log(formikProps.values.price)}
                  <Slider
